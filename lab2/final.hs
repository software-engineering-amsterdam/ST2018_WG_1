...
-- A couple of valid iban numbers
validIban = [
...
-- A couple of invalid iban numbers
inValidIban = [
    "AL86751639367318444714198660",
    "AL89515635252277023782748300",
    "AL39153296222641598198140880",
    "AL47907501989147671525950070",
    "AL55398719849655505231753960",
    "AD2531377125214715353440",
    "AD9764782778017799549340",
    "AD4079739934060166934191",
    "AD3210446914824799260330",
    "AD1781438353588817727120",
    "AT582774098454337650",
    "AT220332087576467470",
    "AT328650112318219880",
    "AT193357281080332570",
    "AT535755326448639810",
    "BE16517682243560",
    "BE46943937718100",
    "BE75270187592711",
    "BE58465045170211",
...
-- Testing all the valid iban numbers run test7ValidIban and test7InValidIban
-- for all the invalid iban numbers. Both test should return True.

test7ValidIban = all (== True) (map iban validIban)
test7InValidIban = all (== False) (map iban inValidIban)
